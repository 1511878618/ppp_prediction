...
def load_single_data(dataname, dataset_config=None, encode_cat=False, data_cut=None, seed=123):
    ...
    if os.path.exists(dataname):
        ...
        filename = os.path.join(dataname, 'data_processed.csv') if os.path.exists(os.path.join(dataname, 'data_processed.csv')) else os.path.join(dataname, 'data_processed.pkl')
